...
import com.tce.smart.common.core.exception.ValidateCodeException;
import com.tce.smart.common.core.model.Result;
import com.tce.smart.common.core.util.WebUtils;
import com.tce.smart.gateway.config.FilterIgnorePropertiesConfig;
	...
	public GatewayFilter apply(Object config) {
		return (exchange, chain) -> {
			...
			if (!StrUtil.containsAnyIgnoreCase(request.getURI().getPath()
					...
					, SecurityConstants.OCR_TOKEN_URL)) {
