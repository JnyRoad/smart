...
class SmartHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		SmartFallbackFactory smartFallbackFactory = new SmartFallbackFactory(target);
		return (T) builder.target(target, smartFallbackFactory);
	}
