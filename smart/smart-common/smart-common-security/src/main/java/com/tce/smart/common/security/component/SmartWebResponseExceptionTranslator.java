...
import com.tce.smart.common.security.exception.*;
 ...
 */
@Slf4j
public class SmartWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	public ResponseEntity<OAuth2Exception> translate(Exception e) {
		...
		if (exception != null) {
			return handleOAuth2Exception(new InvalidException(exception.getMessage(), exception));
		}
		...
		if (exception != null) {
			return handleOAuth2Exception(new MethodNotAllowedException(exception.getMessage(), exception));
		}
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new SmartAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers, HttpStatus.valueOf(status));
