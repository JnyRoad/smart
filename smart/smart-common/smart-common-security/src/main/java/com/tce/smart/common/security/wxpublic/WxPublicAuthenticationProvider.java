 ...
 */
@Slf4j
public class WxPublicAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) {
		WxPublicAuthenticationToken wxAuthenticationToken = (WxPublicAuthenticationToken) authentication;
		...
		WxPublicAuthenticationToken authenticationToken = new WxPublicAuthenticationToken(userDetails, userDetails.getAuthorities());
	...
	public boolean supports(Class<?> authentication) {
		return WxPublicAuthenticationToken.class.isAssignableFrom(authentication);
	}
}
