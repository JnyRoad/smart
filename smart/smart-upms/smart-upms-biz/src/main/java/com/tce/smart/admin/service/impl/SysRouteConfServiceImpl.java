...
import com.tce.smart.admin.api.entity.SysRouteConf;
import com.tce.smart.admin.mapper.SysRouteConfMapper;
import com.tce.smart.admin.service.SysRouteConfService;
import com.tce.smart.common.core.constant.CommonConstants;
import com.tce.smart.common.gateway.vo.RouteDefinitionVO;
...
public class SysRouteConfServiceImpl extends ServiceImpl<SysRouteConfMapper, SysRouteConf> implements SysRouteConfService {
	...
	public Mono<Void> updateRoutes(JSONArray routes) {
		...
		List<SysRouteConf> routeConfList = routeDefinitionVOList.stream().map(vo -> {
			...
			routeConf.setOrderNumber(vo.getOrder());
