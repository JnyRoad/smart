  ...
  <div class="business-form-item clearance"  v-if="!disable">
    ...
    <div class="business-form-item__value">
      <div class="business-input">
        <input class="business-input__inner no-border tce-input__inner" cursor-spacing="100" :maxlength="computedFormOption.maxlength" v-model="formData" :placeholder="placeholder" :readonly="readonly"/>
      </div>
    </div>
  </div>
</template>
