    ...
    <tce-form ref="tceForm">
      <tce-form-group>
       <tce-form-item required field="fellowName" :valueData="itemInfo.fellowName" requiredMessage="请输入" type="input" label="访客姓名" placeholder="请输入"></tce-form-item>
        ...
        <tce-form-item required v-if="cause == 5 || cause == 7" field="certPic" :valueData="itemInfo.certPic"  type="upload-image-single" label="证件照片" placeholder="请上传证件照片"></tce-form-item>
      </tce-form-group>
    </tce-form>
    <page3Bottom>
