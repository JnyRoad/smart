  ...
  <div class="page3">
    ...
    <tce-form ref="tceForm">
      <tce-form-group>
        ...
        <tce-form-item required field="receptionistName" :valueData="hostInfor.receptionistName" requiredMessage="请输入被访人姓名" type="input" label="姓名" placeholder="请输入"></tce-form-item>
        <tce-form-item required field="receptionistPhone" :valueData="hostInfor.receptionistPhone" requiredMessage="请输入被访人手机号" type="phone" label="手机号" placeholder="请输入"></tce-form-item>
      </tce-form-group>
    </tce-form>
    <page3Bottom>
...
export default {
  ...
  created() {
    ...
    this.storageLoad()
    this.hostInfor.parkId = PARKID
    this.hostInfor.parkName = '裕同科技许昌园区'
    if (this.code) {
      this.getNoticeApi()
      this.getOpenId()
    } else {
