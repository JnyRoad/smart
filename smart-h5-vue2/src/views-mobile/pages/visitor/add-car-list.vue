...
<template>
  <div class="page3">
    <div class="page3-list" v-if="carList && carList.length>0">
      <div class="top-tip">已添加车辆（{{carList.length}}辆）</div>
      <div class="item" v-for="(item, index) in carList" :key="index">
        <div class="item-title">
          <div class="item-title_left">{{item.plate}}</div>
        ...
        <div class="item-info">
          <div class="item-info_row">
            <div class="item-info_label">
              <tce-label-justify label="司机姓名:"></tce-label-justify>
            </div>
            <div class="item-info_value -ellipsis">{{item.name}}</div>
          </div>
          <!-- <div class="item-info_row">
            <div class="item-info_label">
              <tce-label-justify label="司机籍贯:"></tce-label-justify>
            </div>
            <div class="item-info_value -ellipsis">{{item.nativePlace}}</div>
          </div> -->
        </div>
      </div>
    </div>
    ...
    <page3Bottom>
      <div slot="inner" class="btn-inner">
        <button @click="add" class="tce-button tce-button--primary is-round is-plain">新增车辆</button>
