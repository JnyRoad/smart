  ...
  /******/ ([
      ...
      (function () {
	    ...
	    MegaPixImage.prototype.render = function (target, options, callback) {
	        ...
	        var srcImage = this.srcImage
	            var src = srcImage.src
	            var srcLength = src.length
	            var imgWidth = srcImage.naturalWidth; var imgHeight = srcImage.naturalHeight
	            var width = options.width; var height = options.height
	            var maxWidth = options.maxWidth; var maxHeight = options.maxHeight
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var Promise = __webpack_require__(1)
	    var BlobFormDataShim = __webpack_require__(5)
	    var exif = __webpack_require__(6)
      ...
      Lrz.prototype.init = function () {
	    var that = this
	        ...
	        var fileIsBase64 = /^data:/.test(file)
	        var img = new Image()
	        var canvas = document.createElement('canvas')
	        var blob = fileIsString ? file : URL.createObjectURL(file)
