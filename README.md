...
`smart` 是裕同智慧园区项目代码目录，包含后端基础平台、业务微服务、管理端前端、微信 H5、本地 Docker 环境、发布脚本和项目文档。
...
└── smart-h5/                 # 微信 H5：Next.js + React + antd-mobile
```
...
| `smart-h5/` | 面向微信内嵌环境的移动 H5，覆盖登录、首页、访客、宿舍、放行、待办等移动端流程。 | Next.js 16、React 19、TypeScript、antd-mobile、Tailwind CSS |
