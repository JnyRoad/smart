...
- [ ] TXXX [P] Additional behavior tests for the affected story in tests/unit/
...
- For behavior changes, business-behavior tests MUST be written and FAIL before implementation
...
```bash
# Launch all behavior tests for User Story 1 together:
