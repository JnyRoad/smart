...
本记录对应 [本轮规格](spec.md#2026-09-05-指令精简修订) 和 T017–T023。仅调整长期指令、模板、资料归属及相应清单摘要；不改业务代码，不修改 Skills。
...
初次验证时，项目修改位于独立任务 worktree，尚未提交、推送或合并；新增文档尚未进入 Git 提交。随后旅途已授权 PR 交付、问题修复和条件合并，范围见 [规格](spec.md#pr-交付授权)。共享主 checkout 的原有删除和未跟踪目录保持原状。Skills 中审计发现的旧默认仍保留，项目入口已明确以本项目权威规则处理冲突。
