...
public class PrintSubjectSourceTest {
 ...
 @Test public void supplierCannotBorrowStaffIdCardWithoutVerifiedAssociation()throws Exception{
  jdbc.update("INSERT INTO SMT_SECURITYAREA_SUPPLIER VALUES (5,1,0,'供应商')");jdbc.update("INSERT INTO SMT_SUPPLIER_PERSON VALUES (10,5,0,'长期人员')");assertEquals(1,search("SUPPLIER_PERSON","长期",1,20).path("total").asInt());expectCode("SUPPLIER_CARD_SOURCE_NOT_CONFIGURED",()->source.load("1","SUPPLIER_PERSON","10"));jdbc.update("UPDATE SMT_SECURITYAREA_SUPPLIER SET PARK_ID=2");expectCode("PRINT_SUBJECT_NOT_FOUND",()->source.load("1","SUPPLIER_PERSON","10"));
 }
