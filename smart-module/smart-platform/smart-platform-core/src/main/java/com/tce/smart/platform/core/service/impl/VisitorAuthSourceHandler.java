...
@Component public class VisitorAuthSourceHandler extends VisitorAuthSourceSupport {
 public VisitorAuthSourceHandler(VisitorAuthOperationMapper mapper){super(mapper);}
