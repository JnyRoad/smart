 ...
 */
@Data
public class ReleaseApplyMainRespDTO extends BaseDTO {
	/**
	 * 放行人级别
	 */
	@ApiModelProperty(value = "放行人级别")
	private String sqrjbDesc;
	...
	private String fxddDesc;

	/**
	 * 到达地点
	 */
	@ApiModelProperty(value = "到达地点")
	private String ddddDesc;
	...
	private String wpfxlbDesc;

	/**
	 * 是否返厂
	 */
	@ApiModelProperty(value = "是否返厂")
	private String sffcDesc;
