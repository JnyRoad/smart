...
import com.tce.smart.bridge.isc.util.BeanUtils;
import com.tce.smart.bridge.isc.util.ReflectUtils;
...
public class HBaseServiceImpl implements HBaseService, InitializingBean, ApplicationContextAware {
	...
	@Override
	public boolean createTable(Class<? extends com.tce.smart.bridge.isc.entity.Table> table) {
	 ...
	 */
	@Override
	public <T extends com.tce.smart.bridge.isc.entity.Table> Result get(T model) {
	 ...
	 */
	@Override
	public <T extends com.tce.smart.bridge.isc.entity.Table> T query(T model) {
		String tableName = table(model.getClass());
		Table table = null;
		try {
			if (!hbaseAdmin.tableExists(tableName)) {
	 ...
	 */
	@Override
	public <T extends com.tce.smart.bridge.isc.entity.Table> boolean put(T model) {
		String tableName = table(model.getClass());
		String rowKey = model.getKey();
		Map<String, ? extends com.tce.smart.bridge.isc.entity.Family> columnFamilies = family(model);
		Table table = null;
		try {
			if (!hbaseAdmin.tableExists(tableName)) {
				log.warn("数据表不存在，tableName：{}", tableName);
	...
	@Override
	public <T extends com.tce.smart.bridge.isc.entity.Table> boolean delete(T model) {
		String tableName = table(model.getClass());
		String rowKey = model.getKey();
	 ...
	 */
	@Override
	public boolean dropTable(Class<? extends com.tce.smart.bridge.isc.entity.Table> table) {
	...
	public void afterPropertiesSet() {
		final Map<String, com.tce.smart.bridge.isc.entity.Table> handlers = BeanFactoryUtils.beansOfTypeIncludingAncestors(applicationContext, com.tce.smart.bridge.isc.entity.Table.class, true, true);
	 ...
	 * @return
	 */
	private String table(Class<? extends com.tce.smart.bridge.isc.entity.Table> model) {
		com.tce.smart.bridge.isc.annotation.Table table = AnnotationUtils.findAnnotation(model, com.tce.smart.bridge.isc.annotation.Table.class);
	 ...
	 * @return
	 */
	private List<String> family(Class<? extends com.tce.smart.bridge.isc.entity.Table> tClass) {
		return Arrays.stream(tClass.getDeclaredFields())
				.filter(field -> Objects.nonNull(field.getAnnotation(com.tce.smart.bridge.isc.annotation.Family.class)))
				.map(Field::getName)
				.collect(Collectors.toList());
	}
	 ...
	 * @return
	 */
	private <T extends com.tce.smart.bridge.isc.entity.Table> Map<String, ? extends com.tce.smart.bridge.isc.entity.Family> family(T table) {
		Map<String, com.tce.smart.bridge.isc.entity.Family> family = new HashMap<>();
		Arrays.stream(table.getClass().getDeclaredFields())
				.filter(field -> Objects.nonNull(field.getAnnotation(com.tce.smart.bridge.isc.annotation.Family.class)))
				.forEach(field -> family.put(field.getName(), (com.tce.smart.bridge.isc.entity.Family) ReflectUtils.getFieldValue(table, field)));
		return family;
	}
	 ...
	 * @return
	 */
	private List<String> qualifier(Class<? extends com.tce.smart.bridge.isc.entity.Family> tClass) {
		return Arrays.stream(tClass.getDeclaredFields())
				.map(Field::getName)
				.collect(Collectors.toList());
	}
	 ...
	 * @return
	 */
	private <T extends com.tce.smart.bridge.isc.entity.Family> Map<String, Object> qualifier(T familyDTO) {
	...
	private <T extends com.tce.smart.bridge.isc.entity.Table> T toBean(Result result, Class<T> tClass) {
	...
	private String key(){
		Field field = Arrays.stream(ReflectUtils.getFields(com.tce.smart.bridge.isc.entity.Table.class))
				.filter(f -> Objects.nonNull(f.getAnnotation(com.tce.smart.bridge.isc.annotation.Key.class)))
