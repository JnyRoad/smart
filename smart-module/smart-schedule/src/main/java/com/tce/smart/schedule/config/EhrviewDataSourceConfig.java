...
@MapperScan(basePackages = {"com.tce.smart.ehrview.core.mapper"}, sqlSessionTemplateRef = "ehrviewSqlSessionTemplate")
...
//	@Primary
	public SqlSessionFactory getSqlSessionFactory(@Qualifier("ehrviewDataSource") DataSource dataSource) throws Exception {
		...
		//添加model路径
//		sqlSessionFactory.setTypeAliasesPackage("com.tce.smart.guard.core.mapper");
