...
//public class OvwYsdepController extends BaseController {
//
//    @Autowired
...
//        List<OvwYsdep> ovwYsdepList = iOvwYsdepService.getByCompId(compId);
...
//        OvwYsdep ovwYsdep = iOvwYsdepService.getByDepId(depId);
...
//    	 List<OvwYsdep> ovwYsdepList = iOvwYsdepService.getParentDep(depId);
//         return success(ovwYsdepList, OvwYsdepRespDTO.class);    }
//
//
//}
