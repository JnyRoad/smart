...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements com.tce.smart.data.webservice.client.WorkflowService {
    ...
    private java.lang.String WorkflowServiceHttpPort_address = "http://10.0.20.69//services/WorkflowService";
    ...
    public com.tce.smart.data.webservice.client.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.tce.smart.data.webservice.client.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tce.smart.data.webservice.client.WorkflowServiceHttpBindingStub _stub = new com.tce.smart.data.webservice.client.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tce.smart.data.webservice.client.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tce.smart.data.webservice.client.WorkflowServiceHttpBindingStub _stub = new com.tce.smart.data.webservice.client.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
