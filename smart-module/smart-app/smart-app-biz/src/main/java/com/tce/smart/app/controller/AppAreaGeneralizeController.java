...
@RestController
@AllArgsConstructor
@RequestMapping("/appgeneralize")
public class AppAreaGeneralizeController extends BaseController {
	...
	public Result getAppSubjectOnline(Page page, @PathVariable(required = false)Integer parkId) {
		...
		String catalogCode = SubjectCatalog.PARK_GENERAL.type();
	...
	public Result addSubject(@RequestBody AddAppSubjectAo addAppSubjectAo) {
		Integer subjectId = appSubjectService.subjectInsert(addAppSubjectAo, SubjectCatalog.PARK_GENERAL.type());
