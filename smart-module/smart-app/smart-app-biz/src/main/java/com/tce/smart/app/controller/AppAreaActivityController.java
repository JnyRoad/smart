...
public class AppAreaActivityController extends BaseController {
	...
	public Result getAppSubjectOnline(Page page,@PathVariable(required = false) Integer parkId) {
		...
		String catalogCode = SubjectCatalog.PARK_ACTIVITY.type();
	...
	public Result addSubject(@RequestBody AddAppSubjectAo addAppSubjectAo) {
		Integer subjectId = appSubjectService.subjectInsert(addAppSubjectAo, SubjectCatalog.PARK_ACTIVITY.type());
