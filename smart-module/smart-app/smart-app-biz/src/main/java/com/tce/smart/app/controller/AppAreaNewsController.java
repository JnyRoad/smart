...
public class AppAreaNewsController extends BaseController {
	...
	public Result getAppSubjectOnline(Page page, @PathVariable(required = false)Integer parkId) {
		...
		String catalogCode = SubjectCatalog.PARK_NEWS.type();
	...
	public Result addSubject(@RequestBody AddAppSubjectAo addAppSubjectAo) {
		Integer subjectId = appSubjectService.subjectInsert(addAppSubjectAo, SubjectCatalog.PARK_NEWS.type());
