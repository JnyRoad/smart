...
import com.tce.smart.app.vo.fore.ParkInstroduceDetailVo;
 ...
 *
 * @author mckaywu
 * @date 2019-06-18 11:26:22
 */
@Component
public class ParkInstroduceDetailWrapper extends BaseWrapper<AppSubject, ParkInstroduceDetailVo> {
	...
	@Override
	protected ParkInstroduceDetailVo warp(AppSubject appSubject) throws IOException {
		ParkInstroduceDetailVo vo = new ParkInstroduceDetailVo();
		...
		if (appContentText != null) {
			...
			vo.setInstroduceContent(appContentText.getTextDesc());
