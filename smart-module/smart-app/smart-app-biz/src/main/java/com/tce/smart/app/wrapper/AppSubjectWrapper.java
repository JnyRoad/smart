...
@Component
public class AppSubjectWrapper extends BaseWrapper<AppSubject, AppSubjectVo> {
	...
	@Override
	protected AppSubjectVo warp(AppSubject appSubject) throws IOException {
		AppSubjectVo vo = new AppSubjectVo();
