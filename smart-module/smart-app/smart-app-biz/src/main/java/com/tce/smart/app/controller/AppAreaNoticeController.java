...
public class AppAreaNoticeController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value = {"/pageOnline"}, method = RequestMethod.GET)
	public Result getAppSubjectOnline(Page page) {
		String publishFlag = PublishState.ONLINE.getCode();
		String catalogCode = SubjectCatalog.PARK_NOTICE.type();
		IPage<AppSubject> iPage = appSubjectService.getAppSubjectPage(page, publishFlag, catalogCode, null);
	 ...
	 * @return
	 */
	@RequestMapping(value = {"/pageOffline"}, method = RequestMethod.GET)
	public Result getAppSubjectOffline(Page page) {
	 ...
	 * @return
	 */
	@RequestMapping(value = {"/pageWait"}, method = RequestMethod.GET)
	public Result getAppSubjectWait(Page page) {
	...
	public Result addSubject(@RequestBody AddAppSubjectAo addAppSubjectAo) {
		Integer subjectId = appSubjectService.subjectInsert(addAppSubjectAo, SubjectCatalog.PARK_NOTICE.type());
