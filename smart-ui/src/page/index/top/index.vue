<template>
  <div class="avue-top">
    <div class="top-bar__left">
      ...
      <!-- <div class="top-btns">
        <el-button type="text" icon="icon-yutong-home1" @click="goHome">返回首页</el-button>
      </div> -->
      <div class="top-btns">
        <el-button type="text" icon="" @click="goPanel">可视化面板</el-button>
      </div>
    ...
    <div class="top-bar__right">
      <el-button v-if="isShow" type="text" style="margin-right: 30px" icon="" @click="goQrCode">打印访客条</el-button>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const s = localStorage.getItem('parkList')
      if(s == '10322' || s == '5000021'){
        this.isShow = false
      }else{
        this.isShow = true
      }
