      ...
      <section class="my-basic-inner">
        ...
        <avue-crud ref="crud" :page="page" :data="tableData" :table-loading="tableLoading" :option="tableOption" @size-change="sizeChange" @current-change="currentChange" @selection-change="selectChange">
          <template slot-scope="scope" slot="menu">
            <el-button type="text" icon="el-icon-view" @click="queryStatementDetail(scope.row)">查看</el-button>
          </template>
        </avue-crud>

        <!-- 水电告警记录明细弹窗 -->
        <el-dialog title="详情" ref="mdialog"  class="dialog_form config_form" width="600px" @close="closeStatementDetail" :visible.sync="statementDetailVisible">
          <el-scrollbar class="my-scrollbar" :native="false">
            <div class="contentCell">
              <div class="leftCell">告警类型</div>
              <div class="rightCell">123123123123123</div>
            </div>

            <div class="contentCell">
              <div class="leftCell">告警内容</div>
              <div class="rightCell">123123123123123</div>
            </div>

            <div class="contentCell">
              <div class="leftCell">告警来源</div>
              <div class="rightCell">123123123123123</div>
            </div>

            <div class="contentCell">
              <div class="leftCell">告警时间</div>
              <div class="rightCell">123123123123123</div>
            </div>
          </el-scrollbar>

          <div slot="footer" class="dialog-footer" v-if="showBtmBtn==1">
            <template>
              <el-button type="primary" @click="clickIgnore">忽 略</el-button>
              <el-button type="primary" @click="clickProcessed">已处理</el-button>
            </template>
          </div>
...
import { tableOption } from '@/const/crud/platform/dormitory/water_warning_record'
...
export default {
  ...
  methods: {
    ...
    queryStatementDetail(row) {
      ...
      //   console.log(this.statementDetailData)
      // })
    },
    searchSubmit(form) {
      //搜索
...
.config_form ::v-deep {
  ...
  .contentCell .leftCell{
    width: 30%;
    height: 100%;
  }
  .contentCell .rightCell{
    height: 100%;
  }
  .a1,.a2{
    font-size: 16px;
