...
export default {
  data() {
    ...
    var badgeValidator = (rule, value, callback) => {
      let staffId = this.infoForm.staffId;
      if (this.validatenull(staffId)) {
        callback(new Error("请查询对接人员信息"));
      } else {
        callback();
      }
    };
    return {
      ...
      addRules: {
        ...
        badge: [
          ...
          // {validator: badgeValidator, trigger: 'blur'}
        ]
      },
      selectForm: {
        compId: ""
