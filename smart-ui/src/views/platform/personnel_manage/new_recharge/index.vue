        ...
        <div class="top-menu">
          ...
          <div class="top-right">
            ...
            <el-button
              ...
              @click="syncToC6(searchForm)"
              v-if="searchForm.syncStatus===1"
            >同步充值名单到C6</el-button>
            <el-button
              type="primary"
...
import {
    deleteRecharge
  } from "../senior_recharge/recharge_service.js";
import { getCompTree } from "@/api/platform/_publicService";
import { tableOption } from "@/const/crud/platform/personnel_manage/new_staff_recharge";
import { getDateMonth } from "@/util/util";
import { mapGetters } from "vuex";
import selectBU from "../senior_recharge/components/select_bu";
...
export default {
  ...
  watch: {},
  created() {
    this.searchForm.checkMonth = getDateMonth();
