...
<script>
import { getAppauth, getRecruitment, getDeptTree, postDeptSave, getDeptList, getSearchStaff, delDept, getDeptDetails, getStaffPage, getStaff, postAddStaff, postDelStaff, getDirector } from '@/api/platform/basic/personnel_manage'
