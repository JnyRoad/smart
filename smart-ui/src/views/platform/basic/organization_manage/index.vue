      ...
      <section class="my-basic-inner">
        ...
        <el-form ref="searchForm" :inline="true" :model="searchForm" class="topForm" size="mini">
          <el-form-item label="组织名称" prop="keyWord">
            <el-input v-model="searchForm.keyWord" placeholder="组织名称" clearable></el-input>
          </el-form-item>
        </el-form>
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="园区选择" prop="park">
                    <el-select v-model="dialogFromData.park" placeholder="请选择园区">
...
<script>
import { getDataList, delOrg, postSaveOrg, getParkAll, getDetails } from '@/api/platform/basic/organization_manage'
