      ...
      <section class="my-basic-inner">
        ...
        >
          <template slot-scope="scope" slot="menu">
            ...
            <el-button type="text" icon="el-icon-view" @click="ckImg(scope.row,scope.$index)">查看详情</el-button>
          </template>
        </avue-crud>
...
<script>
import { fetchList } from "@/api/platform/records/staff";
import { fetchMenuTree } from "@/api/platform/limit/index";
import { tableOption } from "@/const/crud/platform/records/staff";
