        ...
        <el-col :lg="8" :md="8" class="box-outer box-left">
          ...
          <div class>
            ...
            <table class="lit-table">
              ...
              <tr>
                <td>车品牌</td>
                <td>{{carInfo.vehicleBrand==0?'未知':carInfo.vehicleBrand}}</td>
              </tr>
              <tr>
                <td>车颜色</td>
                <td>{{carInfo.vehicleColorDesc}}</td>
              </tr>
            </table>
          </div>
          <div class>
            ...
            <table class="lit-table">
              <tr>
                <td>出入园区</td>
                <td>{{carInfo.parkName}}</td>
              </tr>
              <tr>
                <td>出入地点</td>
                <td>{{carInfo.areaName}}</td>
              </tr>
              <tr>
                <td>出入类型</td>
                <td>{{carInfo.eventTypeDesc}}</td>
              </tr>
              <tr>
                <td>出入时间</td>
                <td>{{carInfo.snapTime}}</td>
              </tr>
            </table>
          </div>
          <div class>
            ...
            <table class="lit-table">
              ...
              <template v-if="carInfo.driverType==1">
                <tr>
                  <td>工号</td>
                  <td>{{carInfo.staffBadge}}</td>
                </tr>
                <tr>
                  <td>BU</td>
                  <td>{{carInfo.compName}}</td>
                </tr>
                <tr>
                  <td>部门</td>
                  <td>{{carInfo.depName}}</td>
                </tr>
                <tr>
                  <td>岗位</td>
                  <td>{{carInfo.jobName}}</td>
                </tr>
                <tr>
                  <td>职层</td>
                  <td>{{carInfo.jcheName}}</td>
                </tr>
                <tr>
                  <td>手机号</td>
              ...
              <template v-if="carInfo.driverType==2">
                <tr>
                  <td>所属单位</td>
        ...
        <el-col :lg="16" :md="16" class="box-outer">
          ...
          <div class="folder-outer">
            <div class="folder-line">
              ...
              <div class="img">
                <viewer>
                  <img :src="carInfo.snapPhoto || errorImgPeaple()" :onerror="errorImgPeaple()" />
                </viewer>
              </div>
            </div>
...
export default {
  ...
  methods: {
    goBack() {
      let path = '/platform/entrance/vehicle'
      this.$router.push({
        path: path,
        query: {
