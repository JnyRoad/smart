                ...
                <el-tabs v-model="activeName" style="border: 1px solid #dcdfe6; min-height: 400px; width: 800px" type="border-card">
                  <el-tab-pane label="视频" name="0">
                    <div class="picture-box">
                      ...
                      <input class="fileBtn" ref="uploadVideoBtn" type="file" accept="video/mp4" @change="myVideoChange($event)" />
                  ...
                  <el-tab-pane label="图片" name="1">
                    <div class="picture-box">
                      ...
                      <input class="fileBtn" ref="uploadBtn" type="file" accept="image/png, image/jpeg" @change="myChange($event)" />
                  ...
                  <el-tab-pane label="PDF" name="2">
                    <div class="picture-box">
                      ...
                      <input class="fileBtn" ref="uploadPPTBtn" type="file" accept="application/pdf" @change="myPPTChange($event)" />
