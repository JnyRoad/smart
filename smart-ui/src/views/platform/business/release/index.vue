...
<script>
import { fetchList, addObj } from './_service'
import { tableOption } from '@/const/crud/platform/business/release'
...
export default {
  ...
  methods: {
    ...
    //编辑
    handleDetail(row) {
      const src = `/platform/business/release/detail`
      this.$router.push({
        path: src,
        query: {
          id: row.id,
