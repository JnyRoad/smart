      ...
      <section class="my-basic-inner">
        ...
        >
          <el-form :rules="rules" ref="addform" :model="addform" label-width="110px">
           ...
           <el-form-item label="工资签收提醒" prop="deadline">
              <div class="content1">
                <span>每月</span>
                <div>
            ...
            <el-form-item label="">
              <div class="tip1">*避免出现签收提醒已发出 但实际未发放情况，提醒日宜晚于实际发薪日。</div>
            </el-form-item>
            <el-form-item label="签收确认截止至" prop="delayLine">
              <div class="content1">
                <div>
...
<script>
  ...
  import { tableOption } from '@/const/crud/platform/business/salary_config'
