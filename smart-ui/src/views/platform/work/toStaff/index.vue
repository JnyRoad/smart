...
<script>
import { fetchList } from "@/api/platform/work/to_staff";
import { fetchMenuTree } from "@/api/platform/limit/index";
import { tableOption } from "@/const/crud/platform/work/to_staff";
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, index) {
      const src = `/platform/work/toStaff/detail/${row.id}`;
      this.$router.push({
        path: src,
        query: {
          queryPage: this.page,
