    ...
    <el-scrollbar class="my-scrollbar" :native="false">
      <section class="my-basic-inner">
        ...
        <el-form ref="searchForm" :inline="true" :model="searchForm" class="topForm" size="mini">
          ...
          <el-form-item label="离职时间" prop="timeRange">
            <el-date-picker
...
<script>
import { fetchList } from "@/api/platform/work/leaveApplication";
import { fetchMenuTree } from "@/api/platform/limit/index";
import { tableOption } from "@/const/crud/platform/work/leaveApplication";
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, index) {
      const src = `/platform/work/leaveApplication/detail/${row.id}`;
      this.$router.push({
        path: src,
        query: {
          queryPage: this.page,
