...
<script>
import { fetchList } from "@/api/platform/work/over_time";
import { fetchMenuTree } from "@/api/platform/limit/index";
import { tableOption } from "@/const/crud/platform/work/over_time";
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, index) {
      const src = `/platform/work/overTime/detail/${row.recordId}`;
      this.$router.push({
        path: src,
        query: {
          queryPage: this.page,
