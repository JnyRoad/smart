...
<script>
import { fetchList } from "@/api/platform/work/break_off";
import { fetchMenuTree } from "@/api/platform/limit/index";
import { tableOption } from "@/const/crud/platform/work/break_off";
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, index) {
      const src = `/platform/work/breakOff/detail/${row.recordId}`;
      this.$router.push({
        path: src,
        query: {
          queryPage: this.page,
