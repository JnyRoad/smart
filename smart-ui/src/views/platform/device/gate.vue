<!--设备管理，闸机管理  -->
<template>
  <div class="my-basic-container device gate">
      ...
      <section class="my-basic-inner">
        <div class="top-menu">
          <div class="top-right">
            ...
            <el-button type="primary" icon="el-icon-plus" @click="addFormVisible = true">添加闸机</el-button>
                  ...
                  <dd>
                    ...
                    <div class="info-tbl">
                      ...
                      <!-- <div style="float:right">
                         <el-button type="primary" @click="permittedList(item)" class="perm-btn" plain round >重新下发</el-button>
                      </div> -->
                    </div>
                  </dd>
                </dl>
        ...
        <el-dialog title="添加闸机" class="dialog_form" width="700px" :visible.sync="addFormVisible">
          <el-form
            :rules="addRules"
            :inline="true"
            ref="addForm"
            ...
            label-position="top"
          >
            <el-form-item label="闸机名称" prop="deviceName">
            ...
            <el-form-item label="闸机IP" prop="deviceIp">
            ...
            <el-form-item label="设备标识" prop="deviceTag">
              <el-select v-model="addForm.deviceTag" clearable>
                <el-option label="考勤机" :value="1"></el-option>
        ...
        <el-dialog title="编辑闸机" class="dialog_form" width="700px" :visible.sync="editFormVisible">
          <el-form
            :rules="rules"
            :inline="true"
            ref="editForm"
          ...
          >
            ...
            <el-form-item label="设备标识" prop="deviceTag">
              <el-select v-model="editForm.deviceTag" clearable>
                <el-option label="考勤机" :value="1"></el-option>
                <el-option label="门禁" :value="2"></el-option>
              </el-select>
            </el-form-item>
