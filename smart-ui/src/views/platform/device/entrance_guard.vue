      ...
      <section class="my-basic-inner">
        <div class="top-menu">
          <div class="top-right">
            ...
            <el-button type="primary" icon="el-icon-plus" @click="addFormVisible = true">添加门禁机</el-button>
        ...
        <el-dialog title="添加门禁机" class="dialog_form" width="700px" :visible.sync="addFormVisible">
          <el-form
            :rules="addRules"
            :inline="true"
            ref="addForm"
            ...
            label-position="top"
          >
            <el-form-item label="门禁机名称" prop="deviceName">
            ...
            <el-form-item label="门禁机IP" prop="deviceIp">
        ...
        <el-dialog title="编辑门禁机" class="dialog_form" width="700px" :visible.sync="editFormVisible">
          <el-form
            :rules="rules"
            :inline="true"
            ref="editForm"
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        addLoading: false,
        editLoading: false,
        addFormVisible: false, //添加门禁机
        editFormVisible: false, //编辑门禁机
        editDisabled: false,
        activeColor: "#10CC8F",
