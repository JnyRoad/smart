<!--设备管理，道闸管理  -->
<template>
  <div class="my-basic-container device automatic">
    <el-scrollbar class="my-scrollbar" :native="false">
      <section class="my-basic-inner">
        <div class="top-menu">
          <div class="top-right">
            ...
            <el-button
              ...
              plain
            >清空</el-button>
            <el-button type="primary" icon="el-icon-plus" @click="addFormVisible = true">添加道闸</el-button>
                    ...
                    <div class="info-tbl">
                      ...
                      <div class="tbl_row">
                        <div class="tbl_cell tbl_cell2">
                          ...
                          <div>
                            <el-button type="text" @click="handleClear(item)" class="perm-btn perm-btn2" >清空</el-button>
                            <el-button type="primary" @click="editLed(item)" class="perm-btn" plain round :disabled="item.deviceVendor!=1" >显示屏</el-button>
                            <el-button type="primary" @click="permittedList(item)" class="perm-btn" plain round  >通关车辆</el-button>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <el-dialog title="添加道闸" class="dialog_form" width="700px" :visible.sync="addFormVisible">
          <el-form
            :rules="rules"
            :inline="true"
            ref="addForm"
          ...
          >
            ...
            <el-form-item label="设备厂家" prop="deviceVendor">
              <el-select v-model="addForm.deviceVendor" clearable>
                ...
                <el-option label="臻识" value="3"></el-option>
                <el-option label="道尔" value="4"></el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="子类型" prop="deviceSubtype">
              <el-select v-model="addForm.deviceSubtype" clearable>
                <el-option
            ...
            <el-form-item label="LED显示屏IP" prop="ledScreenIp">
              <el-input v-model="addForm.ledScreenIp" clearable></el-input>
            </el-form-item>
            <el-form-item label="LED显示屏端口" prop="ledScreen">
              <el-input v-model="addForm.ledScreen" clearable></el-input>
            </el-form-item>
        ...
        <el-dialog title="编辑道闸" class="dialog_form" width="700px" :visible.sync="editFormVisible">
          <el-form
            :rules="rules"
            :inline="true"
            ref="editForm"
          ...
          >
            ...
            <el-form-item label="子类型" prop="deviceSubtype">
              <el-select v-model="editForm.deviceSubtype" clearable>
                <el-option
                  v-for="item in parking"
                  :key="item.id"
                  :label="item.name"
            ...
            <el-form-item label="LED显示屏IP" prop="ledScreenIp">
              <el-input v-model="editForm.ledScreenIp" clearable></el-input>
            </el-form-item>
            <el-form-item label="LED显示屏端口" prop="ledScreen">
              <el-input v-model="editForm.ledScreen" clearable></el-input>
            </el-form-item>
            <el-form-item label="设备标签" prop="tagIds">
...
export default {
  ...
  data() {
    ...
    return {
      addLoading: false,
      editLoading: false,
      addFormVisible: false, //添加道闸
      editFormVisible: false, //编辑道闸
      activeColor: "#10CC8F",
  ...
  methods: {
     ...
     */
    permittedList(item) {
      const src = `/platform/device/vehicle_list/${item.id}`;
      this.$router.push({
        path: src,
        query: {
          queryPage: this.page,
     ...
     */
    editLed(item) {
      const src = `/platform/device/ledInfo/${item.id}`;
      this.$router.push({
        path: src,
        query: {}
      });
     ...
     */
    editLimit() {
      const src = `/platform/device/automatic_limit`;
      this.$router.push({
        path: src
      });
    },
